...
def pageLayout():
    ...
    layout = ds.html.Div([
        ...
        ds.dcc.Dropdown(legenda.processState, value = [legenda.processState[1]], multi = True, searchable = False, id = 'finished-dropdown-my', placeholder = 'PROCESSO', style = {'width': 400}),
