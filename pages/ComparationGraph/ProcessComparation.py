...
def pageLayout():
    ...
    layout = ds.html.Div([
        ...
        ds.dcc.Checklist(["SETTIMANA", "MESE", "MESE DELL'ANNO", "TRIMESTRE", "TRIMESTRE DELL'ANNO", "ANNO"], value = ['MESE'], id = "date-checklist-pr", inline = True, style = {'display':'inline'}, inputStyle = {'margin-left': "20px"}),
