...
def pageLayout():
    ...
    layout = ds.html.Div([
        ...
        ds.html.H2("EVENTI DEI PROCESSI"),
        ...
        ds.dcc.Dropdown(importantEventsType, multi = True, id = 'event-dropdown-ae', placeholder = 'Seleziona tipo di evento...', style = {'width': 300}),
...
@ds.callback(
    ...
    [ds.Input('event-dateranger-ae', 'start_date'), 
        ...
        ds.Input('event-dropdown-ae', 'value')])
